...
public class SaveLoader : MonoBehaviour, ISaver
{
    ...
    public void Init(ProgressBarSO progressBarData, PlayerDataSO playerData, ZonesSO zonesData, SpawnChancesSO spawnChancesData)
    {
    ...
    public void Init(SkinDataSO[] skinsData, TutorialSO tutorialData, AudioSettingSO musicOptions, AudioSettingSO sfxOptions, ImageSO musicButtonData, ImageSO sfxButtonData)
    {
